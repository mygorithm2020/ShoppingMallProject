...
<table id="cartList1">
      ...
      <c:forEach items="${productList}"  var="productVO">
		      <tr>  
			        ...
			        <td>${productVO.num} </td>    
			        <td><a href="market.do?command=product_detail&pseq=${productVO.num}"><h3 class="hhh">${productVO.name}</h3> </a></td>
			        <td><fmt:formatNumber value="${productVO.price}" type="currency"/> </td>
			        <td>${productVO.count} </td>
			        <%-- <td><a href="market.do?command=product_detail&oseq=${productVO.num}">조회</a></td> --%>
					<td>
      ...
      <!-- <div id="buttons" style="float: right">
       ...
       onclick="location.href='market.do?command=index'"> 
      </div> -->
