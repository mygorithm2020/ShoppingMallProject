...
function product_go_cart() {
	...
	alert("장바구니에 들어갔습니다.")
			 document.frm.action ="market.do?command=cart_insert";
			 	document.frm.submit();
...
function product_go_rent() {
	...
	theForm.to.focus();
		 ...
		 if (confirm('대여하시겠습니까?')) {
			 ...
			 document.frm.action ="market.do?command=rent_write";
			 	document.frm.submit();
		 }
	 }
...
function product_go_mov(){
	document.frm.action = "market.do?command=mypage";
	document.frm.submit();
}
...
function product_go_delete(){
	...
	document.frm.action = "market.do?command=product_delete&pseq=" + pseq;
	document.frm.submit();
...
function product_go_mod_form(){
	...
	document.frm.action = "market.do?command=product_update_form&pseq=" + pseq;
	document.frm.submit();
}
...
function product_go_mod_save() {
	...
	theForm.content.focus();
		 ...
		 if (confirm('수정하시겠습니까?')) {
			 ...
			 document.frm.action = "market.do?command=product_update";
			 document.frm.submit();
		 }
	 }
}
...
function product_go_save(){
	...
	var theForm = document.frm;
		...
		theForm.action = "market.do?command=write_product";
		theForm.submit();
	}
}
