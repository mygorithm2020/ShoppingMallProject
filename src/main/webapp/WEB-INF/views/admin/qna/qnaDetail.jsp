...
<%@ include file="/admin/ADheader.jsp"%>
<%@ include file="/admin/sub_menu.jsp"%>
<script type="text/javascript">
   function go_rep(qseq){
      	var theForm = document.frm;
    	theForm.qseq.value=qseq;
    	theForm.action="shop.do?command=admin_qna_repsave";
    	theForm.submit();
   }   
   function go_list() {
    	var theForm = document.frm;
    	theForm.action="shop.do?command=admin_qna_list";
    	theForm.submit();
   }
</script>
<article>
...
<table id="orderList">
		<tr><th width="20%">제목</th><td> ${qnaVO.subject} ${qnaVO.rep} </td></tr>
   		<tr><th>등록일</th><td> <fmt:formatDate value="${qnaVO.indate}"/> </td></tr>
		<tr><th>내용</th><td> ${qnaVO.content}</td></tr>
</table>
