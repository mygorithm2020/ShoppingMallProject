...
(member_seq.nextval, '백승규', 'qwe', '1111', 'yrs01131@gmail.com', '010-5555-6666', '03012' ,'서울시 종로구 구기동 54-6', 'm', 19940704 , sysdate);

insert into member(num, name, id, pw, email, phone,zipcode,address, gender, birth, indate) values
(member_seq.nextval, '권애지', 'qwer', '2222', 'ae1234@gmail.com', '010-5555-6666', '01234' ,'서울시 용산구 원효로 216', 'f', 19890131 , sysdate);
...
product_seq.nextval, 'qwe', '프린터 대여합니다. ', '삼성프린터 ', 10000, 1, '삼성프린터.png', '종로평창동' ,'레이저젯 프린터로 토너 많이 남았어요', sysdate, 0, '1');
...
values(product_seq.nextval, 'qwe', '노트북 빌려드립니다', '노트북', '1', 'A1.jpg', '도산가로수길', 'NT930XCJ-K716A제품입니다', '1', '3', '1');
insert into product(num, id, title, name, count, img, locationname, content, category, rentcount, classify)
values(product_seq.nextval, 'qwer', '노트북 빌려드립니다', '컴퓨터', '1', 'A2.jpg', '논현힐탑', '애플 아이맥 27형 2019년형 (MRR12KH/A) 제품입니다', '1', '2', '1');

insert into product(num, id, title, name, count, img, locationname, content, category, rentcount, classify)
values(product_seq.nextval, 'qwer', '카메라 빌려드립니다', '카메라', '1', 'B1.jpg', '삼성역', '후지필름 X-A7제품입니다', '2', '3', '1');
--insert into product(num, id, title, name, count, img, locationname, content, category, rentcount, classify)
...
--price 부분 추가 필요
insert into rentcart(num, rnum, id, count, borrow, turn,  price)
values (rentcart_seq.nextval, 2, 'qwe', 1, '2020-04-17', '2020-07-17', 8000);
--
...
values(qna_seq.nextval, '안녕하세요', 'qwe', '안녕하세요~', '안녕하세요~~~~', '1');

insert into qna(num, title, id, content, indate, result)
values(qna_seq.nextval, '안녕하세요', 'qwer', '안녕하세요~', '2020-03-15', '0');
...
values(rent_seq.nextval, '카메라', 3, 'qwe', '2020-04-17', '2020-04-19', '천호역', 50000,1);
